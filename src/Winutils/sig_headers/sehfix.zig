...
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t = extern struct {
    major: u32 = 0,
    minor: u32 = 0,
};
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group_t = extern struct {
    pattern: [*c]const u8 = null,
    mask: [*c]const u8 = null,
    length: u32 = 0,
    build_count: u32 = 0,
    versions: [*c]const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t = null,
};
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group0_pattern: [20]u8 = [20]u8{
    72,
    137,
    92,
    36,
...
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group0_mask: [3]u8 = [3]u8{
    255,
    255,
    15,
};
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group0_versions: [347]WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t = [347]WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t{
    WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t{
        .major = 10240,
        .minor = 16384,
    },
    WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t{
...
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group1_pattern: [20]u8 = [20]u8{
    76,
    139,
    220,
    73,
...
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group1_mask: [3]u8 = [3]u8{
    255,
    255,
    15,
};
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group1_versions: [462]WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t = [462]WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t{
    WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t{
        .major = 15063,
        .minor = 0,
    },
...
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group2_pattern: [16]u8 = [16]u8{
    72,
    137,
    92,
    36,
...
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group2_mask: [2]u8 = [2]u8{
    255,
    255,
};
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group2_versions: [319]WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t = [319]WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t{
    WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t{
        .major = 19041,
        .minor = 207,
    },
...
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group3_pattern: [24]u8 = [24]u8{
    72,
    139,
    196,
    72,
...
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group3_mask: [3]u8 = [3]u8{
    255,
    255,
    255,
};
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group3_versions: [48]WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t = [48]WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t{
    WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_version_t{
        .major = 26100,
        .minor = 1,
    },
...
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_GROUPS: [4]WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group_t = [4]WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group_t{
    WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group_t{
        .pattern = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group0_pattern)),
        .mask = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group0_mask)),
        .length = @truncate(@sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group0_pattern)) / @sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group0_pattern[@as(c_int, 0)]))),
        .build_count = @truncate(@sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group0_versions)) / @sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group0_versions[@as(c_int, 0)]))),
        .versions = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group0_versions)),
    },
    WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group_t{
        .pattern = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group1_pattern)),
        .mask = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group1_mask)),
        .length = @truncate(@sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group1_pattern)) / @sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group1_pattern[@as(c_int, 0)]))),
        .build_count = @truncate(@sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group1_versions)) / @sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group1_versions[@as(c_int, 0)]))),
        .versions = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group1_versions)),
    },
    WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group_t{
        .pattern = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group2_pattern)),
        .mask = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group2_mask)),
        .length = @truncate(@sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group2_pattern)) / @sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group2_pattern[@as(c_int, 0)]))),
        .build_count = @truncate(@sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group2_versions)) / @sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group2_versions[@as(c_int, 0)]))),
        .versions = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group2_versions)),
    },
    WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group_t{
        .pattern = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group3_pattern)),
        .mask = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group3_mask)),
        .length = @truncate(@sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group3_pattern)) / @sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group3_pattern[@as(c_int, 0)]))),
        .build_count = @truncate(@sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group3_versions)) / @sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group3_versions[@as(c_int, 0)]))),
        .versions = @ptrCast(@alignCast(&WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_group3_versions)),
    },
};
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_GROUP_COUNT: usize = @sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_GROUPS)) / @sizeOf(@TypeOf(WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_GROUPS[@as(c_int, 0)]));
...
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_H = "";
...
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_DLL_NAME = "ntdll";
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_FUNCTION_NAME = "RtlInsertInvertedFunctionTable";
pub const WSIG_NTDLL_RTLINSERTINVERTEDFUNCTIONTABLE_X64_ARCH = "x64";
